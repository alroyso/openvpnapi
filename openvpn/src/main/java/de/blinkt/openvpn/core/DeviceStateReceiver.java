...
public class DeviceStateReceiver extends BroadcastReceiver implements ByteCountListener, OpenVPNManagement.PausedStateCallback {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ConnectivityManager.CONNECTIVITY_ACTION.equals(intent.getAction())) {
            ...
            //VpnStatus.updateStateString("openvpn","networkStateChange");
            Log.d("openvpn","networkStateChange");
        } else if (Intent.ACTION_SCREEN_OFF.equals(intent.getAction())) {
            Log.d("openvpn","ACTION_SCREEN_OFF");
           // VpnStatus.updateStateString("openvpn","ACTION_SCREEN_OFF");
          ...
          //  VpnStatus.updateStateString("openvpn","ACTION_SCREEN_ON");
       ...
       // VpnStatus.updateStateString("onReceiveopenvpn","都没进入");
